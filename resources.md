...
- CMOS analog design textbooks
- Cadence Virtuoso/Spectre user notes
- OP AMP design references

## 작성 규칙

링크나 책을 추가할 때는 어떤 장/주제가 도움이 되었는지 한 줄로 메모합니다. 외부 자료의 질문/풀이를 그대로 복사하지 말고, 본인이 이해한 정의, 설계 방법, 검증 포인트로 재작성합니다.
