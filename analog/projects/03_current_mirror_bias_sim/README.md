# Current Mirror and Bias Simulation

## Objective

current mirror의 current copy, output resistance, compliance voltage, cascode 효과, BMR/BGR 기본 특성을 확인한다.
