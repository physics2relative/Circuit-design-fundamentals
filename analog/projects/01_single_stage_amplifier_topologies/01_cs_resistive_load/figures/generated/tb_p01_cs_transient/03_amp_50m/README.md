# tb_p01_cs_transient - FIN = 1 MHz, VIN_AMP = 50 mV, CL = 100 fF Generated Results

이 문서는 `run_and_plot.py`가 자동 생성한다.

## CS Transient Small-Signal Response (FIN = 1 MHz, VIN_AMP = 50 mV, CL = 100 fF)

![CS Transient Small-Signal Response (FIN = 1 MHz, VIN_AMP = 50 mV, CL = 100 fF)](./05_cs_transient_waveform.svg)
