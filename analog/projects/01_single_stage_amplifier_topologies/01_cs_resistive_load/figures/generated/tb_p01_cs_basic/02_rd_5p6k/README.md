# tb_p01_cs_basic - RD = 5.6 kΩ Generated Results

이 문서는 `run_and_plot.py`가 자동 생성한다.

## CS DC Transfer (RD = 5.6 kΩ)

![CS DC Transfer (RD = 5.6 kΩ)](./01_dc_transfer.svg)

- 결과 의미: CS의 반전 전달 특성과 bias 가능한 구간을 보여 준다.
- 확인할 것: 출력이 rail에 붙는 구간, 음의 기울기 구간과 clipping 경계를 확인한다.

## CS Drain Current (RD = 5.6 kΩ)

![CS Drain Current (RD = 5.6 kΩ)](./02_drain_current.svg)
