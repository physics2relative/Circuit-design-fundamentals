# Source Follower and Common-gate Simulation

## Objective

source follower의 buffer 특성과 common-gate의 낮은 input resistance/wideband 특성을 확인한다.
...
- DC operating point
- AC gain
- input/output resistance estimation
