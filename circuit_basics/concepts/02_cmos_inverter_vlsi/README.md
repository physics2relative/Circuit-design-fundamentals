# 2. CMOS Inverter and VLSI Basics

CMOS inverter는 digital VLSI의 가장 기본적인 gate이다. MOSFET의 on/off 동작(소자 물리는 `semiconductor_devices/` 참조), noise margin, propagation delay, dynamic power, short-circuit power를 한 번에 설명할 수 있는 기준 회로이다.
