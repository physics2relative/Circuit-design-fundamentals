...
11. [STA Interview Checklist](./11_sta_interview_checklist.md)
...
STA는 waveform simulation보다 constraint와 timing report 해석이 핵심이다. 따라서 이 대단원은 개념, SDC 문법, timing report를 읽는 기준을 중심으로 정리한다.
