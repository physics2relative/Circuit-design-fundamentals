...
SDC 문법 예시는 별도 문서인 [SDC Constraint Syntax Basics](./10_sdc_constraint_syntax_basics.md)에 정리한다. 이 문서에서는 IO timing constraint의 의미를 중심으로 정리한다.
...
- 구체적인 SDC 문법은 [SDC Constraint Syntax Basics](./10_sdc_constraint_syntax_basics.md)에 따로 정리한다.
